    ...
    def search(
        ...
        *,
        ...
        request = SearchRequest(
            ...
            coreml_compute_units=self.coreml_compute_units,
    ...
    *,
    ...
    with _data_dir_context(data_dir, config_dir=config_dir, cache_dir=cache_dir):
        ...
        request = SearchRequest(
            ...
            coreml_compute_units=settings.coreml_compute_units,
...
def _resolve_settings(
    *,
    ...
    return RuntimeSettings(
        ...
        local_device=local_device if local_device is not None else config.local_device,
